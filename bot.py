...
CHANNELS = [
    (
        "Channel 1",
        "https://t.me/team_tiranga",
        "@team_tiranga"
    ),
    (
        "Channel 2",
        "https://t.me/public_sg_community",
        "@public_sg_community"
    ),
    (
        "Channel 3",
        "https://t.me/public_sg_updated",
        "@public_sg_updated"
    ),
    (
        "Channel 4",
        "https://t.me/Sparks_Corporation",
        "@Sparks_Corporation"
    ),
    (
        "Channel 5",
        "https://t.me/check_momos_1",
        "@check_momos_1"
    ),
    (
        "Channel 6",
        "https://t.me/check_momos_2",
        "@check_momos_2"
    ),
]
...
# =========================================================
# FIND CHANNELS USER HAS NOT JOINED
# =========================================================
    ...
    if not video_id:
        ...
        await context.bot.send_message(
            ...
            text=(
                ...
                "⚠️ Abhi admin ne koi video save nahi ki."
            )
        )
...
async def admin_video(
    ...
    await update.message.reply_text(
        ...
        "ye latest video automatically milegi."
    )
...
async def broadcast(
    ...
    for user_id in users:
        ...
        try:
            ...
            # Small delay for Telegram rate limits
...
async def admin(
    ...
    await update.message.reply_text(
        ...
        f"🎥 Saved video: {video_status}\n\n"
        "🎥 Video bhejo → Auto-save\n\n"
        "📢 Broadcast:\n"
        "Kisi message/video ko reply karo "
        "→ /broadcast"
    )
